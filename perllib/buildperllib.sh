...
for i in ../aaa/acct-mgmt/src/lib/lib ../aaa/authtoken/src/perl/lib ../management/mgmt/perl/lib ../management/util/perl/lib ../management/util/perl-Krb5 ../poll/lib ../management/stab/perl/src/lib ../management/appauthal/perl/*/lib; do
