...
Requires: perl-Net-IP, perl-Net-DNS, perl-NetAddr-IP, jazzhands-perl-common >= 0.68.0, perl-Crypt-Rijndael, perl-Crypt-Eksblowfish, perl-Digest-HMAC, perl-Crypt-CBC, perl-DateTime-Format-Strptime
