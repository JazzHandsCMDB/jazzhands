...
#       --url=http://www.appnexus.com '--author=K Z Win <kwin@appnexus.com>' '--packager=K Z Win <kwin@appnexus.com>' --group=Applications/AppNexus --no-sign --no-sign --release=7 --requires=perl-JazzHands-AppAuthAL,perl-LDAP --provides=perl(JazzHands::LDAP) --force /home/kwin/rpm/SOURCES/JazzHands-LDAP.tar.gz
...
%changelog
* Thu Sep 13 2012 kwin@01.kwin-sand.nym1.appnexus.net
- Initial build.
