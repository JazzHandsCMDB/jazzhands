...
#       --no-sign --group=Applications/AppNexus --requires=perl-JazzHands-AppAuthAL,perl-LDAP --no-requires=perl(JazzHands::AppAuthAL),perl(Net::LDAP) --spec-only --force --no-depchk '--author=K Z Win <kwin@appnexus.com>' '--packager=K Z Win <kwin@appnexus.com>' --url=http://www.appnexus.com /home/kwin/JazzHands-LDAP.tar.gz
...
#!/bin/sh
/usr/lib/rpm/find-requires |grep -v -e 'perl(JazzHands::AppAuthAL)' -e 'perl(Net::LDAP)' 
EOF
...
%changelog
* Wed May 16 2012 kwin@09.kwin-sand.nym1.appnexus.net
- Initial build.