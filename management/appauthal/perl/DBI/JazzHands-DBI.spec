...
#       --no-sign --release=1 --group=Applications/AppNexus --requires=perl-JazzHands-AppAuthAL,perl-DBI --no-requires=perl(JazzHands::AppAuthAL),perl(DBI) --spec-only --force --no-depchk '--author=K Z Win <kwin@appnexus.com>' '--packager=K Z Win <kwin@appnexus.com>' --url=http://www.appnexus.com /home/kwin/JazzHands-DBI.tar.gz
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname JazzHands-DBI
...
#!/bin/sh
/usr/lib/rpm/find-requires |grep -v -e 'perl(JazzHands::AppAuthAL)' -e 'perl(DBI)' 
EOF
...
%changelog
* Wed May 23 2012 kwin@09.kwin-sand.nym1.appnexus.net
- Initial build.
