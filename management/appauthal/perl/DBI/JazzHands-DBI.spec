...
#       --url=http://www.appnexus.com '--author=K Z Win <kwin@appnexus.com>' '--packager=K Z Win <kwin@appnexus.com>' --group=Applications/AppNexus --no-sign --no-sign --release=6 --requires=perl-JazzHands-AppAuthAL,perl-DBI --provides=perl(JazzHands::DBI) --spec-only --force /home/kwin/SOURCES/JazzHands-DBI.tar.gz
