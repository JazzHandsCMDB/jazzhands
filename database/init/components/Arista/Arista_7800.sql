...
--
	...
	PERFORM * FROM val_slot_physical_interface WHERE
		slot_physical_interface_type = 'Arista 78XX Supervisor' AND
	...
	IF NOT FOUND THEN
		...
		VALUES
			('Arista 78XX Supervisor', 'chassis_slot'),
			('Arista 78XX Linecard', 'chassis_slot');
		...
		WITH z AS (
			...
			VALUES
				('Arista 78XX Supervisor', 'Arista 78XX Supervisor',
				 'chassis_slot', 'Arista 78XX Supervisor', 'N'),
				('Arista 78XX Linecard', 'Arista 78XX Linecard',
				 'chassis_slot', 'Arista 78XX Linecard', 'N')
