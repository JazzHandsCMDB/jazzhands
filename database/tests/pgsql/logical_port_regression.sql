...
DO $$
DECLARE
	comptype	jazzhands.component_type%ROWTYPE;
	devtype		jazzhands.device_type%ROWTYPE;
	slottype	jazzhands.slot_type%ROWTYPE;
	device1		jazzhands.device%ROWTYPE;
	device2		jazzhands.device%ROWTYPE;
	device3		jazzhands.device%ROWTYPE;
	comp1		jazzhands.component%ROWTYPE;
	comp2		jazzhands.component%ROWTYPE;
	comp3		jazzhands.component%ROWTYPE;
	comp1slot1	jazzhands.slot%ROWTYPE;
	comp1slot2	jazzhands.slot%ROWTYPE;
	comp2slot1	jazzhands.slot%ROWTYPE;
	comp2slot2	jazzhands.slot%ROWTYPE;
	comp3slot1	jazzhands.slot%ROWTYPE;
	comp3slot2	jazzhands.slot%ROWTYPE;
	mlag		jazzhands.mlag_peering%ROWTYPE;
	mlag_lp		jazzhands.logical_port%ROWTYPE;
	dev1_lp		jazzhands.logical_port%ROWTYPE;
	dev2_lp		jazzhands.logical_port%ROWTYPE;
	dev3_lp		jazzhands.logical_port%ROWTYPE;
	errmsg		text;
BEGIN
